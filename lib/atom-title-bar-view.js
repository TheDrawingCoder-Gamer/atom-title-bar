...
<<<<<<< HEAD
      var tempLabel = $('<button class="app-menu-label"/>')
=======
      var tempLabel = $('<span class="app-menu-label"/>')
>>>>>>> bc5bea2... Add sort, change display behaviour
...
<<<<<<< HEAD
=======
        subItemElement.mouseleave(function () {
          $(this).children('.menu-item-submenu').hide()
        })
>>>>>>> bc5bea2... Add sort, change display behaviour
